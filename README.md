...
<p>
  ...
  <img src="https://img.shields.io/badge/Automation%20Workflow-FFF4F7?style=flat-square&labelColor=FFF4F7&color=F6C8D8" alt="Automation Workflow" />
...
<!-- Example: ![banner](your-image-link) -->
...
- Currently focused on `AI applications`, `automation workflows`, and `full-stack development`
- Enjoy building lightweight but complete projects that make ideas feel real
- Hope the code I write is not only useful, but also carries a little warmth and personality

## Now

- 🌱 Learning more about LLM applications, engineering practice, and product thinking
- 🛠️ Refining small projects around translation workflows, realtime interaction, and character systems
- 🎐 Thinking about how tools can feel smoother, gentler, and more intentional
...
- GitHub: [QianYan-Art](https://github.com/QianYan-Art)
- Website: [shiqianyan.cn](https://www.shiqianyan.cn)
- Email: [suyuan4071253@163.com](mailto:suyuan4071253@163.com)
